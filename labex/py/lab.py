...
class Tree():
    ...
    def create_tree(self, edges):
        ...
        for edge in edges:
            ...
            #     self.nodes[vertex_1] = []
            # self.nodes[vertex_1].append(vertex_0)
            # if vertex_0 not in vertex_1.children:
            #     vertex_1.children.append(vertex_0)
    ...
    def bfs(self):
        ...
        # print("BFS_____________________")
        while len(queue) != 0:
            
            for _, i in self.nodes.items():
                visited[i.value] = 0
...
#              ('B', 'F'), ('B', 'G'), ('B', 'H'), ('C', 'I'), ('C', 'J'), ('D', 'K'), ('G', 'L'), ('G', 'M'), ('I', 'N'), ('I', 'O'),
#              ('K', 'P'), ('K', 'Q'), ('Q', 'R')]
